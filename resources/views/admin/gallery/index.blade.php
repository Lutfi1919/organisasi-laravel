...
<link rel="stylesheet" href="{{ asset(path: 'css/users.css')}}">
    ...
    <div class="container mb-5" style="margin-top: 100px; font-family: Unbounded;">
        ...
        <div class="d-flex justify-content-end gap-1">
            <a href="{{ route('admin.gallery.trash')}}" class="btn utility-btns btn-secondary"><i class="bi bi-trash"></i> Data Sampah</a>
            <a href="{{ route('admin.gallery.export')}}" class="btn utility-btns btn-primary"><i class="bi bi-file-earmark-spreadsheet"></i> Export Data</a>
            <a href="{{ route('admin.gallery.create')}}" class="btn utility-btns btn-success"><i class="bi bi-plus-circle"></i> Tambah Data</a>
        </div>
                    ...
                    @foreach ($galleries as $key => $gallery)
                        <tr class="fw-light">
                            ...
                            <td class="text-center action-btns">
                                <a href="{{ route('admin.gallery.edit', $gallery['id']) }}" class="btn btn-sm btn-outline-primary"><i class="bi bi-pencil-square me-1"></i>Edit</a>
